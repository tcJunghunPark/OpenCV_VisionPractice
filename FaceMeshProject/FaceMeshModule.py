        ...
        if results.multi_face_landmarks:
            ...
            for faceLms in results.multi_face_landmarks:
                ...
                for id, lm in enumerate(faceLms.landmark):
                    ...
                    #cv2.putText(img, str(id), (x,y), cv2.FONT_HERSHEY_PLAIN, 0.5, (0,255,0), 1) # put id num of each points
                    face.append([x,y])
                    #print(id, x,y)
                faces.append(face) 
        return img, faces
...
def main():
    cap = cv2.VideoCapture("C:/Users/wjdgn/Documents/OpenCV_VisionPractice/FaceDetectionProject/Videos/1.webm")
    pTime = 0
